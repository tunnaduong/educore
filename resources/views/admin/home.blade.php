    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-info">
                ...
                <a href="{{ route('chat.index') }}" class="small-box-footer" wire:navigate>
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
                ...
                <a href="{{ route('notifications.index') }}" class="small-box-footer" wire:navigate>
                    Xem thêm <i class="fas fa-arrow-circle-right"></i>
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-warning">
                ...
                <a href="{{ route('students.index') }}" class="small-box-footer" wire:navigate>
                    Xem thêm <i class="fas fa-arrow-circle-right"></i>
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-danger">
                ...
                <a href="{{ route('users.index') }}" class="small-box-footer" wire:navigate>
                    Xem thêm <i class="fas fa-arrow-circle-right"></i>
                </a>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <!-- Điểm danh -->
                        <div class="col-6 col-md-3 text-center mb-4">
                            <a href="{{ route('attendances.overview') }}" wire:navigate
                                class="text-decoration-none text-dark">
                                <div class="mb-2">
                        ...
                        <!-- Thống kê thu chi -->
                        <div class="col-6 col-md-3 text-center mb-4">
                            <a href="{{ route('admin.finance.index') }}" wire:navigate
                                class="text-decoration-none text-dark">
                                <div class="mb-2">
