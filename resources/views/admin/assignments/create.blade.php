<x-layouts.dash-admin active="assignments">
    ...
    <div class="container py-4">
        ...
        <div class="mb-4">
            ...
            <h4 class="mt-2 text-primary fs-4"><i class="bi bi-journal-text mr-2"></i>{{ __('views.create_new_assignment') }}</h4>
        </div>
                ...
                <form wire:submit.prevent="createAssignment">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea wire:model.defer="description" rows="4" class="form-control @error('description') is-invalid @enderror"
                            id="description" placeholder="{{ __('views.instructions_placeholder') }}"></textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-send mr-1"></i> {{ __('views.assign_assignment') }}
                        </button>
                    </div>
                </form>
            </div>
