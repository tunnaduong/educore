    ...
    <div class="container-fluid">
        <div class="mb-4">
            ...
            <h4 class="mb-0 text-success fs-4">
                <i class="bi bi-folder-symlink-fill mr-2"></i>Sửa bài học
            </h4>
        </div>
            ...
            <div class="row g-0 align-items-stretch">
                            ...
                            <div class="mb-3">
                                ...
                                @if ($oldAttachment)
                                    <div class="mt-2"><a href="{{ asset('storage/' . $oldAttachment) }}"
                                            target="_blank">Tài liệu hiện tại</a></div>
                                @endif
                                @error('attachment')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                ...
                <div
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-muted small mb-0">Cập nhật thông tin bài học, tài liệu, video, slide cho học
                            viên.</p>
                    </div>
                </div>
            </div>
