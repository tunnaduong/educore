            ...
            <div class="card-body">
                <div class="row g-2">
                    <div class="col-md-6">
                        ...
                        <div class="text-muted">{{ __('general.completed_assignments') }}: <span
                                class="fw-medium">{{ $student->stats['completedAssignments'] }}</span>
                        </div>
                        <div class="text-muted">{{ __('general.attendance_rate') }}: <span
                                class="fw-medium">{{ $student->stats['attendanceRate'] }}%</span>
                        </div>
                    </div>
                    </td>
                    <td class="text-end">
                        <div class="d-flex justify-content-end gap-1">
                            ...
                            <a href="{{ route('students.edit', $student) }}" <input wire:model.live="search"
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($student->enrolledClassrooms->count() > 0)
                                        ...
                                        @endif
                                    @else
                                        <span class="text-muted small">{{ __('general.no_classes_registered') }}</span>
                                    @endif
                                </td>
