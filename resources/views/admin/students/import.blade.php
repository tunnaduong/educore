<div>
    ...
    @if ($showModal)
        <!-- Modal Backdrop -->
        <div class="modal-backdrop fade show" wire:click="closeModal"
            style="position: fixed; top: 0; left: 0; z-index: 1040; width: 100vw; height: 100vh; background-color: rgba(0, 0, 0, 0.5);">
        </div>
                            ...
                            <div class="mt-4">
                                ...
                                @if ($importResult['success'])
                                    <div class="alert alert-success">
                                        ...
                                        <p class="mb-0">
                                            <strong>Thành công:</strong> {{ $importResult['successCount'] }} học
                                            viên<br>
                                            @if ($importResult['errorCount'] > 0)
                                                <strong class="text-danger">Lỗi:</strong>
                                                {{ $importResult['errorCount'] }} dòng
                                            @endif
                                        </p>
                                    </div>
                                ...
                                @else
                                    <div class="alert alert-danger">
                                        ...
                                        <p class="mb-0">
                                            {{ $importResult['message'] ?? 'Có lỗi xảy ra khi import file.' }}</p>
                                    </div>
                                @endif
                            </div>
                        @endif
