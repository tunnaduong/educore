    ...
    <div class="container-fluid">
        ...
        <div class="mb-4">
            ...
            <h4 class="mb-0 text-primary fs-4">
                <i class="bi bi-person-plus mr-2"></i>{{ __('general.add_new_student') }}
            </h4>
        </div>
        ...
        <div class="card shadow-sm p-0">
            <div class="row g-0 align-items-stretch">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input wire:model="password" type="password"
                                    ...
                                    placeholder="{{ __('general.enter_password') }}">
                                @error('password')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div
                    ...
                    <img src="/educore-logo.png" alt="{{ __('general.add_new_student') }}" class="mb-3"
                        style="max-width: 90px;">
                    <div class="text-center">
                        <h6 class="text-primary fw-bold mb-2">{{ __('general.add_new_student') }}</h6>
                        <p class="text-muted small mb-0">{{ __('general.create_student_account_desc') }}</p>
                    </div>
                </div>
            </div>
        </div>
