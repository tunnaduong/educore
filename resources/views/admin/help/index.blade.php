                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="helpTabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="guide-tab" data-toggle="tab" href="#guide" role="tab">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="list-group" id="helpSidebar">
                                                    <a href="#students" class="list-group-item list-group-item-action" data-target="students">
                                                        <i class="fas fa-users"></i> Quản lý học sinh
                                                    </a>
                                                    <a href="#classrooms" class="list-group-item list-group-item-action" data-target="classrooms">
                                                        <i class="fas fa-graduation-cap"></i> Quản lý lớp học
                                                    </a>
                                                    <a href="#schedules" class="list-group-item list-group-item-action" data-target="schedules">
                                                        <i class="fas fa-calendar-alt"></i> Quản lý lịch học
                                                    </a>
                                                    <a href="#assignments" class="list-group-item list-group-item-action" data-target="assignments">
                                                        <i class="fas fa-tasks"></i> Quản lý bài tập
                                                    </a>
                                                    <a href="#quizzes" class="list-group-item list-group-item-action" data-target="quizzes">
                                                        <i class="fas fa-question-circle"></i> Quản lý bài kiểm tra
                                                    </a>
                                                    <a href="#lessons" class="list-group-item list-group-item-action" data-target="lessons">
                                                        <i class="fas fa-book-open"></i> Quản lý bài học
                                                    </a>
                                                    <a href="#finance" class="list-group-item list-group-item-action" data-target="finance">
                                                        <i class="fas fa-coins"></i> Quản lý tài chính
                                                    </a>
                                                    <a href="#reports" class="list-group-item list-group-item-action" data-target="reports">
                                            ...
                                            <div class="card-body">
                                                <div id="guideContent">
                                                    ...
                                                    <div class="text-center py-5">
                                                        ...
                                                        <p class="text-muted mt-3">Chọn một mục từ sidebar để xem hướng dẫn chi tiết</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
