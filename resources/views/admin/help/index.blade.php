<x-layouts.dash-admin active="help">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="helpTabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="guide-tab" data-toggle="tab" href="#guide"
                                    role="tab">
                        ...
                        <div class="tab-content mt-3" id="helpTabContent">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="list-group" id="helpSidebar">
                                                    <a href="#students" class="list-group-item list-group-item-action"
                                                        data-target="students">
                                                        <i class="fas fa-users"></i> Quản lý học sinh
                                                    </a>
                                                    <a href="#classrooms" class="list-group-item list-group-item-action"
                                                        data-target="classrooms">
                                        ...
                                        <div class="card">
                                            <div class="card-header bg-light">
                                                <h5 class="card-title mb-0">
                                                    ...
                                                    <span id="guideTitle">Hướng dẫn sử dụng</span>
                                                </h5>
                                            </div>
                                            <div class="card-body">
                                                <div id="guideContent">
                                                    ...
                                                    <div class="text-center py-5">
                                                        ...
                                                        <p class="text-muted mt-3">Chọn một mục từ sidebar để xem hướng
                                                            dẫn chi tiết</p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="contact" role="tabpanel">
                                <livewire:admin.help.contact-form />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            // Tab navigation
            $('#helpTabs a').on('click', function(e) {
                e.preventDefault();
                $(this).tab('show');
            });

            // Sidebar navigation
            $('#helpSidebar a').on('click', function(e) {
                e.preventDefault();
                var target = $(this).data('target');
                loadGuideContent(target);

                // Update active state
                $('#helpSidebar a').removeClass('active');
                $(this).addClass('active');
            });

            function loadGuideContent(section) {
                // TODO: Load content via AJAX or show/hide sections
                var titles = {
                    ...
                    'lessons': 'Quản lý bài học & Tài nguyên',
                    'finance': 'Quản lý tài chính & Thu chi',
                    'reports': 'Báo cáo và thống kê'
                };

                $('#guideTitle').text(titles[section] || 'Hướng dẫn sử dụng');

                // For now, show a placeholder
                $('#guideContent').html(`
                    <div class="text-center py-4">
                        <i class="fas fa-tools fa-3x text-primary"></i>
                        <h5 class="mt-3">${titles[section] || 'Hướng dẫn sử dụng'}</h5>
                        <p class="text-muted">Nội dung hướng dẫn chi tiết sẽ được hiển thị ở đây</p>
                        <div class="bg-light p-3 rounded mt-3">
                            <i class="fas fa-image fa-2x text-muted"></i>
                            <p class="text-muted mt-2">[Ảnh chụp màn hình hướng dẫn]</p>
                        </div>
                    </div>
                `);
            }
...
<div class="card">
    ...
    <div id="collapseStudents" class="collapse" data-parent="#helpAccordion">
        <div class="card-body">
            ...
            <p>Module quản lý học sinh cho phép bạn thêm, chỉnh sửa, xem thông tin chi tiết và theo dõi tiến độ học tập
                của từng học sinh trong hệ thống.</p>
            ...
            <div class="alert alert-warning">
                <strong>⚠️ Cảnh báo:</strong> Hành động này không thể hoàn tác. Dữ liệu học sinh sẽ được lưu trữ trong
                30 ngày trước khi xóa vĩnh viễn.
            </div>
            <ol>
...
<div class="card">
    <div class="card-header" id="headingClassrooms">
        <h2 class="mb-0">
            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse"
                data-target="#collapseClassrooms">
                <i class="fas fa-graduation-cap"></i> Quản lý lớp học
            </button>
        </h2>
    </div>
    <div id="collapseClassrooms" class="collapse" data-parent="#helpAccordion">
        <div class="card-body">
            ...
            <p>Module quản lý lớp học giúp bạn tạo và quản lý các lớp học, phân công giáo viên, học sinh và theo dõi
                tiến độ học tập của từng lớp.</p>
...
<div class="card">
    ...
    <div id="collapseSchedules" class="collapse" data-parent="#helpAccordion">
        <div class="card-body">
            ...
            <p>Module lịch học giúp bạn tạo và quản lý lịch học cho từng lớp, tránh xung đột lịch và đảm bảo hiệu quả
                trong việc sắp xếp thời gian học tập.</p>
            ...
            <div class="alert alert-warning">
                <strong>🔔 Thông báo:</strong> Khi phát hiện xung đột, hệ thống sẽ hiển thị cảnh báo màu đỏ và đề xuất
                thời gian thay thế.
            </div>
...
<div class="card">
    <div class="card-header" id="headingAssignments">
        <h2 class="mb-0">
            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse"
                data-target="#collapseAssignments">
                <i class="fas fa-tasks"></i> Quản lý bài tập
            </button>
        </h2>
    </div>
    <div id="collapseAssignments" class="collapse" data-parent="#helpAccordion">
        <div class="card-body">
            ...
            <p>Module bài tập cho phép bạn tạo, giao bài tập cho học sinh, theo dõi tiến độ nộp bài và chấm điểm một
                cách hiệu quả.</p>

            <div class="alert alert-info">
                <strong>💡 Lưu ý:</strong> Hệ thống hỗ trợ nhiều loại bài tập: văn bản, file đính kèm, hình ảnh, âm
                thanh và video.
            </div>
...
<div class="card">
    ...
    <div id="collapseQuizzes" class="collapse" data-parent="#helpAccordion">
        <div class="card-body">
            ...
            <p>Module bài kiểm tra cho phép bạn tạo các bài kiểm tra trực tuyến với nhiều loại câu hỏi khác nhau, thiết
                lập thời gian và tự động chấm điểm.</p>

            <div class="alert alert-info">
                <strong>💡 Lưu ý:</strong> Hệ thống hỗ trợ câu hỏi trắc nghiệm, tự luận, đúng/sai và có thể tự động chấm
                điểm cho câu hỏi trắc nghiệm.
            </div>
...
<div class="card">
    ...
    <div id="collapseLessons" class="collapse" data-parent="#helpAccordion">
        <div class="card-body">
            ...
            <p>Module bài học cho phép bạn tạo và quản lý các bài học, tài liệu học tập, video bài giảng và tài nguyên
                giáo dục cho học sinh.</p>

            <div class="alert alert-info">
                <strong>💡 Lưu ý:</strong> Hệ thống hỗ trợ nhiều định dạng file: PDF, Word, PowerPoint, video, audio và
                hình ảnh.
            </div>
...
<div class="card">
    ...
    <div id="collapseReports" class="collapse" data-parent="#helpAccordion">
        <div class="card-body">
            ...
            <p>Module báo cáo cung cấp các thống kê chi tiết về tình hình học tập, điểm danh, điểm số và tiến độ của học
                sinh, lớp học để giúp bạn đưa ra quyết định quản lý hiệu quả.</p>

            <div class="alert alert-info">
                <strong>💡 Lưu ý:</strong> Tất cả báo cáo có thể được xuất ra PDF hoặc Excel để chia sẻ với phụ huynh
                hoặc lưu trữ.
            </div>
...
<div class="card">
    ...
    <div id="collapseFinance" class="collapse" data-parent="#helpAccordion">
        <div class="card-body">
            ...
            <p>Module tài chính giúp bạn theo dõi thu chi, quản lý học phí, chi phí vận hành và tạo báo cáo tài chính
                chi tiết cho trung tâm.</p>

            <div class="alert alert-info">
                <strong>💡 Lưu ý:</strong> Tất cả giao dịch tài chính được ghi lại và có thể xuất báo cáo theo thời
                gian.
            </div>
        ...
        <div class="card-body">
            ...
            <div class="text-center">
                ...
                <button class="btn btn-primary btn-sm"
                    onclick="window.open('mailto:support@educore.com?subject=Hỗ trợ EduCore')">
