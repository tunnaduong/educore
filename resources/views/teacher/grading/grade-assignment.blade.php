            ...
            <div class="col-lg-4">
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <div class="mb-3">
                            <label class="form-label fw-semibold">{{ __('general.assignment_type') }}:</label>
                        ...
                        <div class="mb-3">
                            ...
                            <p class="mb-0">{{ $assignment->score ?? __('general.none') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <span class="mb-0">{{ __('general.student_submissions_list') }}</span>
                        </div>
                    ...
                    <div class="card-body p-0">
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th>{{ __('general.submission_time') }}</th>
                        ...
                        @else
                            <div class="text-center py-4">
                                ...
                                <h5 class="text-muted">{{ __('general.no_submissions_yet') }}</h5>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <h6>{{ __('general.student_info') }}</h6>
                                <p><strong>{{ __('general.name') }}:</strong> {{ $selectedSubmission->student->user->name ?? '-' }}</p>
                                <p><strong>Email:</strong> {{ $selectedSubmission->student->user->email ?? '-' }}</p>
                                <p><strong>{{ __('general.submission_time') }}:</strong>
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($selectedSubmission->content)
                                    ...
                                    @elseif ($selectedSubmission->submission_type === 'image')
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">{{ __('general.submission_image') }}:</label>
                                            <div>
                                    ...
                                    @elseif ($selectedSubmission->submission_type === 'video')
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">{{ __('general.submission_video') }}:</label>
                                            <div>
                                                <video controls class="w-100 rounded">
                                    ...
                                    @elseif ($selectedSubmission->submission_type === 'audio')
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">{{ __('general.submission_audio') }}:</label>
                                            <div>
                                                <audio controls class="w-100">
                                                    <source src="{{ Storage::url($selectedSubmission->content) }}"
                                                        type="audio/mpeg">
                                                    {{ __('general.browser_not_support_audio') }}
                                                </audio>
                                                <div class="mt-2">
                                                    <a href="{{ Storage::url($selectedSubmission->content) }}"
                                                        target="_blank" class="btn btn-sm btn-outline-primary">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control"
                                    ...
                                    max="10" step="0.1" placeholder="{{ __('general.enter_score') }}"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary"
                            ...
                            <i class="bi bi-save mr-1"></i>{{ __('general.save_score') }}
                        </button>
                    </div>
                </div>
            </div>
