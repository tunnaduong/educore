            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-0 text-primary fs-4">
                        <i class="bi bi-bell mr-2"></i>{{ __('general.notifications_and_reminders') }}
                    </h4>
                ...
                <div class="d-flex">
                    ...
                    <button wire:click="create" class="btn btn-primary">
                        <i class="bi bi-plus-circle mr-2"></i><span class="d-none d-md-inline">{{ __('general.create_new_notification') }}</span>
                    </button>
                </div>
            </div>
        </div>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input wire:model.live="search" type="text" class="form-control"
                            placeholder="{{ __('general.search_by_title_content') }}">
                    </div>
                    <div class="col-md-3">
                                    ...
                                    <tr
                                        ...
                                        <td>
                                            @if ($notification->scheduled_at)
                                                ...
                                                @else
                                                    <small class="text-muted">{{ __('general.pending') }}</small>
                                                @endif
                                            @else
                    ...
                    <form wire:submit="store">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control @error('class_id') is-invalid @enderror"
                                        wire:model="class_id">
                                        <option value="">{{ __('general.all_classrooms') }}</option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    @error('scheduled_at')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">{{ __('general.leave_empty_send_now') }}</small>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle mr-2"></i><span class="d-none d-md-inline">{{ __('general.create_notification') }}</span>
                            </button>
                        </div>
                    </form>
                </div>
