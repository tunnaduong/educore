        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label text-muted small">{{ __('general.required_submission_types') }}</label>
                            <div class="fw-medium">
                            ...
                            <div class="fw-medium">
                                @if ($assignment->attachment_path)
                                    <a href="{{ asset('storage/' . $assignment->attachment_path) }}" target="_blank"
                                        ...
                                        <i class="bi bi-file-earmark-arrow-down"></i> {{ __('general.download') }}
                                    </a>
                                @else
                                    -
                                @endif
                        ...
                        <div class="mb-3">
                            <label class="form-label text-muted small">{{ __('general.video') }}</label>
                            <div class="fw-medium">
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-light">
                        <h5 class="mb-0 text-primary">
                            <i class="bi bi-people mr-2"></i>{{ __('general.students_and_submission_status') }}
                        </h5>
                    </div>
                    <div class="card-body">
                        @if ($students->count() > 0)
                        ...
                        @else
                            <div class="alert alert-info mb-0">
                                <i class="bi bi-info-circle mr-2"></i>{{ __('general.no_students_in_class') }}
                            </div>
                        @endif
                    </div>
                </div>
