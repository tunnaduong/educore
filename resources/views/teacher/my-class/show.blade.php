                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <small class="text-muted">{{ $lesson->created_at->format('d/m/Y') }}</small>
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('teacher.lessons.show', $lesson->id) }}" class="btn btn-outline-warning">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{ route('teacher.lessons.edit', $lesson->id) }}" class="btn btn-outline-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 mb-3">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <p class="text-muted small">{{ Str::limit($assignment->description, 100) }}</p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <small class="text-muted">{{ $assignment->created_at->format('d/m/Y') }}</small>
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('teacher.assignments.show', $assignment->id) }}" class="btn btn-outline-success">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{ route('teacher.assignments.edit', $assignment->id) }}" class="btn btn-outline-primary">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-success">{{ $attendance->present_count ?? 0 }}</span>
                                </td>
                                <td>
