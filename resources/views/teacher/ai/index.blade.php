            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">
                        ...
                        Từ chấm điểm tự động đến tạo bài kiểm tra, AI sẽ giúp bạn tiết kiệm thời gian và nâng cao chất lượng giảng dạy.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="text-center mb-3">
                                ...
                                <p class="text-muted">Chọn bài nộp cần chấm và để AI phân tích nội dung, đưa ra điểm số và nhận xét</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="text-center mb-3">
                                ...
                                <p class="text-muted">Nhập nội dung bài giảng hoặc chọn bài tập để AI tạo ra các câu hỏi kiểm tra phù hợp</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="text-center mb-3">
                                ...
                                <p class="text-muted">Tạo bộ câu hỏi đa dạng để sử dụng cho nhiều bài kiểm tra khác nhau</p>
                            </div>
                        </div>
                    </div>
                </div>
