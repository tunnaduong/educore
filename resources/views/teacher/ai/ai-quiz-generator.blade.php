                                ...
                                <div class="card-body">
                                    <form wire:submit.prevent="generateQuiz">
                                        <div class="mb-3">
                                            ...
                                            <select wire:model="selectedClass" id="selectedClass" class="form-select">
                                        ...
                                        <div class="mb-3">
                                            <label for="selectedLesson" class="form-label">Bài học tiếng Trung</label>
                                            <select wire:model="selectedLesson" id="selectedLesson" class="form-select"
                            ...
                            @elseif ($showPreview && $generatedQuiz)
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="btn-group">
                                            <button wire:click="validateQuiz" class="btn btn-outline-warning btn-sm"
                                                {{ $isProcessing ? 'disabled' : '' }}>
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <strong>Tổng điểm:</strong> {{ $generatedQuiz['total_score'] ?? 0 }}
                                            </div>
                                            <div class="col-md-6">
