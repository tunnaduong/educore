        ...
        <div class="row g-3">
            <div class="col-md-3">
                <a href="{{ route('student.assignments.overview') }}" 
                   class="btn btn-outline-primary w-100 h-100 d-flex flex-column align-items-center justify-content-center py-3" wire:navigate>
            ...
            <div class="col-md-3">
                <a href="{{ route('student.assignments.overview', ['filterStatus' => 'upcoming']) }}" 
                   class="btn btn-outline-warning w-100 h-100 d-flex flex-column align-items-center justify-content-center py-3" wire:navigate>
            ...
            <div class="col-md-3">
                <a href="{{ route('student.assignments.overview', ['filterStatus' => 'overdue']) }}" 
                   class="btn btn-outline-danger w-100 h-100 d-flex flex-column align-items-center justify-content-center py-3" wire:navigate>
            ...
            <div class="col-md-3">
                <a href="{{ route('student.assignments.submissions') }}" 
                   class="btn btn-outline-success w-100 h-100 d-flex flex-column align-items-center justify-content-center py-3" wire:navigate>
