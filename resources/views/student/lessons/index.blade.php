<x-layouts.dash-student active="lessons">
    ...
    @php
        ...
        if ($student && $currentEvaluationRounds->count() > 0) {
            // Kiểm tra xem student đã đánh giá tất cả đợt hiện tại chưa
            $evaluatedRounds = $student->evaluations()
    ...
    @if (!$hasEvaluation && $student && $currentEvaluationRounds->count() > 0)
        ...
        <div class="modal fade show d-block" id="requiredEvaluationModal" tabindex="-1" style="background-color: rgba(0,0,0,0.8); z-index: 1050; overflow-y: auto;">
                ...
                <div class="col-lg-8">
                    <div class="card border-warning">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted">Vui lòng liên hệ admin để được hỗ trợ hoặc chờ đợt đánh giá tiếp theo.</p>
                        </div>
                    </div>
                </div>
            </div>
